 ...
 * @brief 	Impact of 3d water droplet in air onto a solid surface
...
int main()
{
	...
	//----------------------------------------------------------------------
	FluidBody water_block(sph_system, makeShared<GeometricShapeBall>(circle_center, insert_circle_radius, "WaterBody"));
	...
	while (GlobalStaticVariables::physical_time_ < end_time)
	{
		...
		while (integration_time < output_interval)
		{
			...
			Real Dt = 0.142*SMIN(Dt_f,Dt_a,delta_t1,delta_t2,delta_t3,delta_t4); // to make it 1e-7
			// Real Dt = 1.0e-7;
